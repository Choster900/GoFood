...
<body class="restaurant-lp">
                    ...
                    <table class="table product-table" id="table">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th><strong>Condicion</strong></th>
                                <th class="font-weight-bold">
                                    <strong><a href="<?=constant('URL')?>producto/Agregar" class="btn  btn-dark text-white">Agregar</a> </strong>
                                </th>
    ...
    <script type="text/javascript" src="<?=constant('URL')?>public/js/productoAll.js"></script>
    <!-- MDB -->
<script
