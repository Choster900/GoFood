...
<body class="restaurant-lp">
    ...
    <main style="margin-top: 200px">
        <!-- Main Container -->
        <div class="container">
            <h3 class="display-5">Editar Empleado</h3>
            <section class="section my-5 pb-5">
<?php
    $empleado = $this->empleado;
?>
                <!-- Shopping Cart table -->
                <form class="row g-3 needs-validation" action="<?=constant('URL')?>empleado/Update" method="POST" id="FrmProducto">
                    <div class="row">
                    <div class="col-md-1 position-relative">
                            <div class="form-outline">
                                <input type="text" value="<?=$empleado[0]['Id']?>" name="id" class="form-control"
                                    id="validationTooltip01" data-validetta="required" readonly>
                                <label for="validationTooltip01" class="form-label">ID</label>
                            </div>
                        </div>
                        <div class="col-md-4 position-relative">
                            <div class="form-outline">
                                <input type="text" value="<?=$empleado[0]['NameUSer']?>" name="nombre" class="form-control"
                        ...
                        <div class="col-md-4 position-relative">
                            <div class="form-outline">
                                <input type="email" value="<?=$empleado[0]['Addres']?>" class="form-control" name="correo" data-validetta="required"/>
                        ...
                        <div class="col-md-3 position-relative">
                            <div class="form-outline">
                                <input type="text" value="<?=$empleado[0]['Passwords']?>" class="form-control" name="pass" data-validetta="required"/>
